        ...
        try {
            const todasAsMatriculas = await database.Matriculas.findAndCountAll({
                where: {
                    ...
                    status: 'confirmado'
                }, //O primeiro vai ser turma_id, porque turma_id é nome da coluna lá no diagrama de banco, e esse turmaId é o turmaId que estamos recebendo dos parâmetros.
                limit: 20, //limita a quantidade de registros retornados mas não altera o contador. OPCIONAL.
                order: [ //OPCIONAL, apenas para conhecer.
                    ['estudante_id', 'DESC']
                ]
            })
    ...
    static async cancelaPessoa(req, res) {
        ...
        try {
            await database.Pessoas
                .update({ ativo: false }, { where: { id: Number(estudanteId) } }) //O que o método update tem que receber por parâmetro para funcionar? Primeiro ele tem que receber as informações que vão ser atualizadas, que vão ser updated, e depois ele tem que receber um where para saber onde tem que atualizar.
